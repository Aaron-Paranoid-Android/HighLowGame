...
public class HighLowApp {
	...
	/**
	 * A standard lenght double dash line.
	 */
	...
	public static void setupPlayers() {
		...
		System.out.println(HighLowApp.DOUBLE_LINE);
		System.out.println();
		System.out.println("My name is Charlie. I'm a computer.");
		System.out.println("Can you guess the number I'm thinking of between 1 - 100?");
		System.out.println();
	}
	...
	public static boolean guess(Player player) {
		...
		if (playerGuess == HighLowApp.correctAnswer) {
			System.out.println("Yippee!!! " + playerName + " just won this round!");
			player.addWin();
		...
		if (distance < 5)
			System.out.println(playerName + ", you are scalding!");
		else if (distance < 10)
